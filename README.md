![unnamed](https://github.com/user-attachments/assets/0ce90c4f-9d40-489f-9534-e65ece302db7)

🚀 Microservices Architecture Overview

This project demonstrates a simple microservices architecture consisting of three independent services:

👤 User Service — Port 8000 (🗄️ SQL Database)

📦 Product Service — Port 8001 (🗄️ SQL Database)

🛒 Order Service — Port 8002 (🗄️ SQL Database)
